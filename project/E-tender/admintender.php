...
<?php
    ...
    if(isset($_REQUEST['status']))
    {
      ...
      if ($status == '1') {
          $sql ="UPDATE `tenders` SET `tender_status`='0' WHERE `tender_id`='$id'";
          mysqli_query($conn,$sql);
      }
      else{
          $sql ="UPDATE `tenders` SET `tender_status`='1' WHERE `tender_id`='$id'";
          mysqli_query($conn,$sql);
      }
    }
?>
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <th class="action">
                <form method="post" action="admintender.php">
                  <input type="hidden" name="id" value="<?php echo $row['tender_id'];?>">
