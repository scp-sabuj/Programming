...
public class AttendanceFrame extends javax.swing.JFrame implements ActionListener {
    ...
    private void saveMethod() {
        ...
        for (int j = 0; j < len; j++) {
            ...
            if (status1.equals("YES")) {
                ...
                System.out.println(date+" "+sId+" "+sNm+" "+cCode+" "+dept+" "+st+ " "+ tId+" "+section+" "+ session + " "+ year);
                try {
    ...
    private void okMethod() {
        ...
        int numberOfRow = attendanceJTable.getRowCount();
        DefaultTableModel model1 = (DefaultTableModel) attendanceJTable.getModel();
